...
describe('UI Testing using Selenium', function () {
    ...
    it('should load the login page', async function () {
        const loginPagePath = 'file:///D:\PPMPL\prak4\index.html'; // Full path to your HTML file
        await driver.get(loginPagePath);
        const title = await driver.getTitle('Login Page');
    ...
    it('should handle failed login attempts', async function () {
        await driver.get('file:///D:\PPMPL\prak4\index.html'); // Reload the login page
